          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="p-5">
              ...
              <p className="mt-1 text-sm text-[var(--color-muted)]">
                En haut à gauche, le sélecteur isole les données d'une agence. Deux agences contiennent un scénario complet : <strong>Horizon Immobilier</strong> (Lyon) et <strong>Artik</strong> (Charleville-Mézières), cette dernière sur un marché de province aux prix bien plus bas.
              </p>
            </Card>
            <Card className="p-5">
